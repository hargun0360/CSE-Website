...
<div id="theme" className="target">
            ...
            <h1 className="mb-3 mt-5 green-heading">AKGEC</h1>
            <p>Ajay Kumar Garg Engineering College, Ghaziabad established in 1998, is affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow and is approved by the AICTE. The College offers            B. Tech courses in seven disciplines of Engineering and M. Tech courses in Automation & Robotics, Electrical & Electronics Engineering, Computer Science & Engineering, Electronics & Communication Engineering, VLSI and Mechanical Engineering. The college strives for excellence and has the distinction of receiving, Academic Excellence Award for Best Engineering College consecutively for two years from HE the Governor of U.P.
              <br/>
              <br/>
The college has established a number of industry relevant facilities in collaboration with reputed multinational companies. These include KUKA Industrial Robotic Training Centre, NI-Lab VIEW Academy, Bosch Rexroth Centre of Competence in Automation Technologies, Janatics Pneumatic Knowledge Centre, Siemens <b>PLM, Fab Lab and AIA Center for Integrated Automation.</b>
<br></br>
<br></br>
Situated on the Delhi-Hapur Bypass (NH-24), the college is a short trip by road/rail from the National Capital, Delhi. Spread over 40 acres with lush green lawns, the college has 6 academic blocks and all recreational / sports & hostel facilities. 
</p>
            </div>  
  ...
  <div className="container mb-5" >
            ...
            <p>Electrical Engineering Department was started since the inception of the Ajay Kumar Garg Engineering College, in the year 1998. Department is running the undergraduate course in Electrical and Electronics Engineering since 2003 with current intake of 120. Prior to this the undergraduate course was in Electrical Engineering since the inception of the college. The department also runs postgraduate course in Electrical Power and Energy Systems 2009 with intake of 18. Now this post graduate course is renewed as Electrical and Electronics Engineering in 2016. Department is well equipped with state of art undergraduate and post graduate labs, computing & design facilities.  Department has qualified FMs mostly PhD, MTech /ME from the IITs/NITs/Govt Colleges. The department had over 15 B.Tech. students in the AKTU merit list till date.</p>
            </div>
...
Establishment of the Scientific Society here, during the same period is considered as a milestone of the educational movement launched by Syed Ahmad Khan. The Scinde, Punjab & Delhi Railway, connecting Delhi and Lahore, up till Ambala through Ghaziabad was opened in the same year. With the completion of the Amritsar-Saharanpur-Ghaziabad line of the Sind, Punjab and Delhi Railway in 1870, Delhi was connected to Multan through Ghaziabad, and Ghaziabad became the junction of the East Indian Railway and Sind, Punjab and Delhi Railway.
            ...
            <p>
            Uttar Pradesh ('Northern Province') is a state in northern India. With over 200 million inhabitants, it is the most populated state in India as well as the most populous country subdivision in the world. It was created on 1 April 1937 as the United Provinces of Agra and Oudh during British rule, and was renamed Uttar Pradesh in 1950, giving it the acronym UP. The state is divided into 18 divisions and 75 districts, with the state capital being Lucknow, and Allahabad serving as the judicial capital. On 9 November 2000, a new state, Uttaranchal (now Uttarakhand), was carved from the state's Himalayan hill region. The two major rivers of the state, the Ganges and Yamuna, join at Triveni Sangam in Prayagraj and flow further east as Ganges. Other prominent rivers are Gomti and Saryu. The forest cover in the state is 6.1% of the state's geographical area. The cultivable area is 82% of total geographical area and net area sown is 68.5% of cultivable area.
<br/><br/>
